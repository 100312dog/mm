...
class NanoDetPlusHead(ATSSHead):
    ...
    def loss_by_feat(
        ...
        for flatten_bbox_pred, anchors, stride in zip(flatten_bbox_preds_list, anchor_list[0],
            ...
            flatten_decode_bbox_pred = self.bbox_coder.decode(anchors[:, :2].repeat((num_imgs, 1)),
                                                               flatten_bbox_pred_corners)
            flatten_decode_bbox_preds_list.append(flatten_decode_bbox_pred.reshape(num_imgs, -1, 4))
